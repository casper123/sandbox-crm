        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="px-3">
                            <form class="form" enctype="multipart/form-data" method="post" action="<?php echo base_url().'payment/addInvoicePayment' ?>" >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3 mb-2">
                                                    ...
                                                    <select required="required" name="payment_method" id="payment_method" name="payment_method" class="form-control">
                                                            ...
                                                            <option value="MCB">MCB Online Transfer</option>
                                                            <option value="SCB">SCB Online Transfer</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-3 mb-2">
